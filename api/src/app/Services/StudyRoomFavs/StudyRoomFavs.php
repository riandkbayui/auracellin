...
namespace App\Services\StudyRoomFavs;

use App\Services\BaseServices;
use Exception;

class StudyRoomFavs extends BaseServices {

	public $model;

	public function __construct() {
		parent::__construct();
		$this->model = model("StudyRoomFavsModel");
	}
	...
	public function findOne($filter="") {
		if (is_array($filter)) {
			...
			$this->model->where('study_room_favs.id', $filter);
		}
