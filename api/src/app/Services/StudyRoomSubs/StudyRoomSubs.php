...
namespace App\Services\StudyRoomSubs;

use App\Services\BaseServices;
use Exception;

class StudyRoomSubs extends BaseServices {

	public $model;

	public function __construct() {
		parent::__construct();
		$this->model = model("StudyRoomSubsModel");
	}
	...
	public function findOne($filter="") {
		if (is_array($filter)) {
			...
			$this->model->where('study_room_subs.id', $filter);
		}
