...
class Events  extends BaseController {
    ...
    private $upload_path = "uploads/events/";
    ...
    public function getIndex() {
        try {
            ...
            $getTotal = service("Events")->findOne(array_merge($params, [
                ["selectCount", "events.id", "total"]
            ]));

            $params[] = ["orderBy", "events.id", "desc"];
            $params[] = ["select", ["events.id", "events.name", "events.photo", "events.description", "events.status"]];
    ...
    public function getEdit($id){
        try {
            $id = numeric($id);
            $form = service("Events")->findOne([
                ["select", ["id", "name", "photo", "description", "status"]],
                ["where", "id", $id]
            ]);
            if(!$form) {
    ...
    public function postEdit($id){
        ...
        try {
            ...
            if ($this->validate($rules)) {
                ...
                service("Events")->update($event->id, $obj);
    ...
    public function postDelete(){
        try {
            ...
            service("Events")->delete($event->id);
            return $this->respond([
