...
class Webinars  extends BaseController {
    ...
    private $upload_path = "uploads/webinars/";
    ...
    public function getIndex() {
        try {
            ...
            $getTotal = service("Webinars")->findOne(array_merge($params, [
                ["selectCount", "webinars.id", "total"]
            ]));

            $params[] = ["orderBy", "webinars.id", "desc"];
            $params[] = ["select", ["webinars.id", "webinars.name", "webinars.photo", "webinars.description", "webinars.status"]];
    ...
    public function postEdit($id){
        ...
        try {
            ...
            if ($this->validate($rules)) {
                $webinar = service("Webinars")->findOne([
                    ["where", "id", numeric($id)]
                ]);
                ...
                service("Webinars")->update($webinar->id, $obj);
    ...
    public function postDelete(){
        try {
            ...
            service("Webinars")->delete($webinar->id);
            return $this->respond([
