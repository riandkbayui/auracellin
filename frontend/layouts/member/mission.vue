				...
				<div id="sidebar-menu">
					<ul class="metismenu list-unstyled" id="side-menu">
						...
						<li v-on:click.prevent="hide">
							<NuxtLink class="waves-effect" to="/member/missions/home">
						...
						<li v-on:click.prevent="hide">
							<NuxtLink class="waves-effect" to="/member/missions/create">
								<div class="d-flex w-100 justify-content-between">
									<div>
						...
						<li v-on:click.prevent="hide">
							<NuxtLink class="waves-effect" to="/member/missions/me">
								<div class="d-flex w-100 justify-content-between">
									<div>
						...
						<li v-on:click.prevent="hide">
							<NuxtLink class="waves-effect" to="/member/missions/participants">
								<div class="d-flex w-100 justify-content-between">
									<div>
						...
						<li v-on:click.prevent="hide">
							<NuxtLink class="waves-effect" to="/member/missions/histories">
								<i class="mdi mdi-clipboard me-2"></i>
								<span>Riwayat</span>
							</NuxtLink>
						</li>
					</ul>
