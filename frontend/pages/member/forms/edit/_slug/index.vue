                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <button type="button" v-on:click.prevent="copyToClipboard" class="btn btn-outline-primary"><i class="mdi mdi-content-copy"></i></button>
                        </div>
...
export default {
    ...
    methods: {
        ...
        async copyToClipboard() {
            try {
                await navigator.clipboard.writeText(`${location.origin}/form/${this.form.slug}`);
