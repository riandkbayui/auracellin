				...
				<div class="card-body">
					<div class="text-center mb-3">
						<div class="d-inline-block mb-2">
							<div class="wh-72 rounded-circle bg-white bg-opacity-75 d-flex justify-content-center align-items-center">
								<i class="mdi mdi-text-box fsz-32 text-secondary"></i>
							</div>
						</div>

						<h5 class="text-white">{{ form.name }}</h5>
					</div>
