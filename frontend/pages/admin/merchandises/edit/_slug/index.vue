...
<template>
    <div>
        <Breadcrumb title="Edit" :pages="['Admin Area', 'Merchandise']" />
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <div class="input-group-text"><i class="mdi mdi-link"></i></div>
...
<script type="text/javascript">
    export default {
        ...
        async asyncData({$axios, params, error}) {
            try {
                const { data: response } = await $axios.get(`admin/merchandises/edit/${params.slug}`);
                return response;
            } catch (err) {
                console.log(err);
                let err_msg = '';
            ...
            async form_submit(e) {
                if (typeof jQuery !== "undefined") {
                    try {
                        ...
                        const { data: response } = await this.$axios.post(`admin/merchandises/edit/${slug}`, formData, {
                            headers: {
                        ...
                        Swal.fire({
                            ...
                            this.$router.push('/admin/merchandises');
                        });
                    } catch (err) {
                        console.log(err);
                        let err_msg = '';
