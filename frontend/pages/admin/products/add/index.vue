...
<template>
    <div>
        <Breadcrumb title="Tambah Baru" :pages="['Admin Area', 'Produk']" />
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input name="photo" v-on:change.prevent="upload_img" placeholder="Pilih Gambar" value="" class="form-control" type="file" accept=".jpg,.jpeg,.png" autocomplete="off" required>
                    ...
                    <div class="form-group">
                        <label>Harga</label>
                        <input name="price" placeholder="Masukkan harga" value="" class="form-control" type="number" autocomplete="off" required>
            ...
            async form_submit(e) {
                if (typeof jQuery !== "undefined") {
                    try {
                        ...
                        const { data: response } = await this.$axios.post(`admin/products/add`, formData, {
                            headers: {
