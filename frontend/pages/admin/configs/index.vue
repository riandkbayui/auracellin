                ...
                <div v-on:click.prevent="editForm(item)" class="card w-100 mb-2 waves-effect">
                    <div class="card-body">
                        <div class="d-flex gap-2 align-items-center text-primary">
                            <div class="avatar-md ar-1-1 rounded-circle bg-primary-gradient d-flex justify-content-center align-items-center">
                                <i class="mdi mdi-pencil text-secondary fsz-24"></i>
                            </div>
        ...
        <form action="" v-on:submit.prevent="formSubmit" method="post">
            <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-sm modal-dialog-centered">
                    <div class="modal-content bg-secondary text-primary border-primary">
                        <div class="modal-header">
                            <h5 class="text-primary">Formulir</h5>
                        </div>
