...
<template>
	<div>
		...
		<div class="text-end mb-4">
			<NuxtLink class="btn btn-success bg-success bg-secondary" to="/admin/slideshows/add">
				...
				<div class="card w-100 mb-2">
					...
					<div class="card-footer">
						<div class="d-flex gap-2">
							<NuxtLink class="btn btn-primary waves-effect w-100" :to="`/admin/slideshows/edit/${item.id}`">
