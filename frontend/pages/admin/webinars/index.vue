...
<template>
	<div>
		...
		<div class="text-end mb-4">
			<NuxtLink class="btn btn-success bg-success bg-secondary" to="/admin/webinars/add">
				...
				<div class="card w-100 mb-2 overflow-hidden">
					...
					<div class="card-footer">
						<div class="d-flex gap-2">
							<NuxtLink class="btn btn-primary waves-effect w-100" :to="`/admin/webinars/edit/${item.id}`">
