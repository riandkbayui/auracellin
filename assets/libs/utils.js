$(function () {
	...
	$.fn.tinymceSetup = function (configs, cb = '') {
		return $(this).tinymce({
			height: 480,
			plugins: ['advlist autolink link image lists charmap print preview hr anchor pagebreak', 'searchreplace wordcount visualblocks visualchars code fullscreen insertdatetime media nonbreaking', 'save table directionality emoticons template paste'],
...
function defineProp(obj, key, value, onChange = null) {
	Object.defineProperty(obj, key, {
		...
		set(newVal) {
			...
			if(typeof onChange == 'function') {
				onChange.apply(this, [key, newVal])
			}
		},
		enumerable: true,
		configurable: true
